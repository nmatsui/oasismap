...
resource "azurerm_linux_web_app" "frontend" {
  ...
  app_settings = {
    NEXTAUTH_URL                                  = "https://${data.terraform_remote_state.platform.outputs.root_domain_name}"
    ...
    NEXT_PUBLIC_BACKEND_URL                       = "https://backend.${data.terraform_remote_state.platform.outputs.root_domain_name}"
    ...
    KEYCLOAK_CLIENT_ISSUER                        = "https://keycloak.${data.terraform_remote_state.platform.outputs.root_domain_name}/realms/oasismap"
...
resource "azurerm_linux_web_app" "backend" {
  ...
  app_settings = {
    ...
    ADMIN_KEYCLOAK_CLIENT_ID  = "admin-client"
    KEYCLOAK_CLIENT_ISSUER    = "https://keycloak.${data.terraform_remote_state.platform.outputs.root_domain_name}/realms/oasismap"
    FRONTEND_URL              = "https://${data.terraform_remote_state.platform.outputs.root_domain_name}"
...
resource "azurerm_linux_web_app" "keycloak" {
  ...
  app_settings = {
    ...
    KC_HOSTNAME             = "https://keycloak.${data.terraform_remote_state.platform.outputs.root_domain_name}"
    KC_HOSTNAME_ADMIN       = "https://keycloak.${data.terraform_remote_state.platform.outputs.root_domain_name}"
    KC_HTTPS_PORT           = "443"
